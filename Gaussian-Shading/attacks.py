...
#     "view_shift": "Show the scene from a bird's eye view looking straight down"
# }
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='GS_attack_creator')
